/* pandora-sindicato.js */
/**
 * Sindicato module — SindicApp worker-coordination platform.
 * Exposes window.PANDORA_SINDICATO (demo data, persistence, workspace HTML).
 */
/* SINDICATO_FORK_START — extract from Pandora.html for standalone SindicApp / llogateres BCN fork */
(function () {
    'use strict';

    const STORAGE_KEY = 'pandora-sindicato-state-v2';
    const STORAGE_KEY_LEGACY = 'pandora-sindicato-state-v1';
    ...
    function buildWorkspaceHtml(locale, sub, workplaceId, section, filter, context) {
        const ctx = context || {};
        if (!sub) return buildWelcomeHtml(locale);
